...
class TestRun(TestCase):
    def test_push_commit_on_master(self):
        ...
        expected_out = r"""
remote: *** cvs_check: `trunk/repo/"full-double"'
remote: *** cvs_check: `trunk/repo/'full-single''
remote: *** cvs_check: `trunk/repo/`backtick`'
remote: *** cvs_check: `trunk/repo/bad\dir/"two"'
remote: *** cvs_check: `trunk/repo/bad\dir/'one''
remote: *** cvs_check: `trunk/repo/bad\dir/`lish'
remote: *** cvs_check: `trunk/repo/bad\dir/nasa esa'
remote: *** cvs_check: `trunk/repo/bad\dir/normal_filename'
remote: *** cvs_check: `trunk/repo/bad\dir/one'two"3'
remote: *** cvs_check: `trunk/repo/bad\dir/pet`ular'
remote: *** cvs_check: `trunk/repo/front`tick'
remote: *** cvs_check: `trunk/repo/one space'
remote: *** cvs_check: `trunk/repo/subdir/"double"'
remote: *** cvs_check: `trunk/repo/subdir/'single''
remote: *** cvs_check: `trunk/repo/subdir/another\bs.txt'
remote: *** cvs_check: `trunk/repo/subdir/automa`'
remote: *** cvs_check: `trunk/repo/subdir/hello:world'
remote: *** cvs_check: `trunk/repo/subdir/sp ace'
remote: *** cvs_check: `trunk/repo/subdir/time`tock'
remote: *** cvs_check: `trunk/repo/weird:colon.h'
remote: *** cvs_check: `trunk/repo/weird\backslash.c'
remote: *** cvs_check: `trunk/repo/with"double-quote'
remote: *** cvs_check: `trunk/repo/with'single-quote'
